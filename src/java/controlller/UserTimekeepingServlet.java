 ...
 * @author PREDATOR
 */
@WebServlet(name = "UserTimekeepingServlet", urlPatterns = {"/UserTimekeepingServlet"})
public class UserTimekeepingServlet extends HttpServlet {
    private static final String USER_TIMEKEEPING_PAGE = "UserTimekeeping.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = USER_TIMEKEEPING_PAGE;
