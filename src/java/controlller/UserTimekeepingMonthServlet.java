 ...
 * @author PREDATOR
 */
@WebServlet(name = "UserTimekeepingMonthServlet", urlPatterns = {"/UserTimekeepingMonthServlet"})
public class UserTimekeepingMonthServlet extends HttpServlet {
    private static final String USER_TIMEKEEPING_MONTH_PAGE = "UserTimekeepingMonth.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = USER_TIMEKEEPING_MONTH_PAGE;
